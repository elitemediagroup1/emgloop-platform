...
test('fence: no hosting limit or infrastructure product is part of the execution contract', () => {
  ...
  for (const file of ['capability.ts', 'brain-execution.ts', 'brain-result.ts', 'brain-job.ts', 'brain-step.ts', 'brain-trust.ts', 'brain-executor.ts', 'brain-dispatch.ts', 'brain-wait.ts', 'ai-controls.ts']) {
