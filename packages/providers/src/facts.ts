// Fact — the atomic unit a Sensor emits.
//
...
//
// Facts live in @emgloop/providers (alongside the Sensor contract) because
// Sensors are the producers and the platform's dependency direction is
// brain -> providers. Placing Facts here keeps that direction acyclic: the
// Brain may import Facts from providers, but providers never depend on the Brain.
