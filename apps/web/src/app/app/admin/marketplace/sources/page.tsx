// Sources workspace (read-only). Composes existing repositories via the Loop OS design system; no backend/API/DB/schema/Brain/CallGrid changes.
    ...
    <div className="loop-os loop-os--v3 loop-os--v4 loop-os--v5">
          ...
          <div className="loop-grid__content">
            <div className="loop-card loop-market">
              <div className="loop-card__head">
                ...
                <Link className="loop-card__link" href="/app/admin/marketplace/sources">Overview</Link>
              </div>
      ...
      <aside className="loop-rail">
        ...
        <div className="loop-card">
          ...
          <ContextGroup
            title="Related"
            caption="How sources connect across your marketplace."
            links={[
              {
                icon: "chart",
                title: "Campaigns",
                detail: "See the campaigns fed by these sources.",
                href: "/app/admin/marketplace/campaigns",
              },
              {
                icon: "users",
                title: "Buyers",
                detail: "See the buyers receiving this source traffic.",
                href: "/app/admin/marketplace/buyers",
              },
              {
                icon: "building",
                title: "Vendors",
                detail: "Review vendors connected to these sources.",
              ...
              },
              {
                icon: "activity",
                title: "Activity",
                detail: "Follow the live event stream for sources.",
