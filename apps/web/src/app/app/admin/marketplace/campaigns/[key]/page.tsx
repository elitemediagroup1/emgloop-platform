// CallGrid Intelligence — one campaign (Level 3). The page is the shared entity detail,
...
export default async function Page({ params, searchParams }: { params: { key: string }; searchParams?: SearchParams }) {
  ...
  return EntityDetailPage({ dim: 'campaigns', entityKey: decoded(params.key), session, searchParams });
}
