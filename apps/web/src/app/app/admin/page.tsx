...
// Loop OS — Admin dashboard (Phase 2, PR #47). Workspace home; shell only.
...
export default function ADMINDashboard() {
  const ws = workspaceFor('ADMIN');
  return (
    <ShellPage
      eyebrow={ws.label + ' Workspace'}
      title="Dashboard"
      description="Your admin home inside Loop OS. Brain-powered summaries plug in here."
      icon="grid"
      plannedFor={[
